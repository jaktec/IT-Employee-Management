...
class TeamleadSignUpForm(UserCreationForm):
    ...
    def clean_username(self):
       ...
       if not username[0].isupper():
           raise forms.ValidationError("Username should start with a capital letter.")
...
class AdminSignUpForm(UserCreationForm):
    ...
    def save(self):
        ...
        user.email = user.username + str(Admin.objects.count()+1) +"@mail.com"
        user.is_staff = True
        user.save()
...
class StdProjectAppForm(forms.ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        super(StdProjectAppForm, self).__init__(*args, **kwargs)
...
class LeadProjectUpdateForm(forms.ModelForm):
    ...
    # def __init__(self, *args, **kwargs):
    #     super(LeadProjectUpdateForm, self).__init__(*args, **kwargs)
    #     self.fields['attachments'].required = False
...
class NewProjectForm(forms.ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields['to_lead'].required = True  
...
class AssignProjectForm(forms.ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields['developers'].widget.attrs.update({'class': 'col-md-10'})
